...
export function WorkshopMarketingPage({setView}:{setView:(view:AppView)=>void}){
  return <div className="mp-page">
    <main>
      ...
      <section className="mp-cta"><div className="wrap"><div><span>WERKSTATT</span><h2>MotorAtlas als digitale Arbeitsoberfläche deiner Werkstatt starten.</h2></div><button className="btn white xl" onClick={()=>{sessionStorage.setItem('motoratlas_access_mode','workshop');setView('login')}}>Werkstattkonto starten <ArrowRight/></button></div></section>
    </main>
    <PublicFooter setView={setView}/>
  </div>;
}
