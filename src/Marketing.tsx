...
export function Marketing({setView}:{setView:(v:AppView)=>void}){
 return <><Header setView={setView}/><main className="marketing">
  ...
  <section className="section wrap vision"><SectionIntro kicker="DAS PRODUKT ALS GANZES" title={<>Ein System, das schon beim Öffnen <em>nach Premium aussieht.</em></>} text="Das freigegebene MotorAtlas-Design bleibt die visuelle Leitlinie für Website, PWA und Android-App."/><div className="vision-frame"><img src="/product-vision.webp" alt="MotorAtlas Premium Produktvision"/></div></section>
